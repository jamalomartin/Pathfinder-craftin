...
(function sData() {
	...
	sRanger.push({name: 'Select a Ranger spell'});
	data.forEach(function(dataObj) {
		if (dataObj.ranger !== 'NULL') {
			sRanger.push(dataObj);
		}
	})
})()
...
var RangerScrolls = React.createClass({
	...
	render: function () {
		var casterSpells = [];
		var casterSpell = this.state.rangerSpell;
